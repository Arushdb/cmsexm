...
public class VerificationReport {
	...
	private List<String> enrollNoList = new ArrayList<String>(); //added by Jyoti on 9 Nov 2021
	private String requestCode;
	private String requestTypeCode;
	private String requestTypeName;
	private String referEmailId; //added by Jyoti on 13 Nov 2021
	...
	public void setEnrollNoList(List<String> enrollNoList) {
		this.enrollNoList = enrollNoList;
	}

	public List<String> getEnrollNoList() {
		return enrollNoList;
	}

	public void setReferEmailId(String referEmailId) {
		this.referEmailId = referEmailId;
	}

	public String getReferEmailId() {
		return referEmailId;
	}
