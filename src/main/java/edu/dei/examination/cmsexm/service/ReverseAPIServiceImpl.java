...
@Service
public class ReverseAPIServiceImpl implements DegreeDgMainService {

	static Connection connection = null;
	static ResultSet myRs = null;
	static Statement statement= null;
	String baseUrl = "https://deb.ugc.ac.in/api/DebUniqueID/GetAdmissionDetails";
	
	String fetchbaseUrl="https://deb.ugc.ac.in/api/DebUniqueID/GetStudentDetails";
	String fetch_apiKey="HiE*Y79M2HH^HMgkEJEGiN#A4pRa!f5h";
	String fetchClientID ="DEI0507_GetStudentDetails";
	
	String apiKey = "NhHu)$^qGR27!!zNyJXEyR-8R98)n9bR";
	String ClientID = "DEI0507_GetAdmissionDetails";
    ...
    public void reverseapi() throws IOException {

        // Get list of DEBID  with status "N"
