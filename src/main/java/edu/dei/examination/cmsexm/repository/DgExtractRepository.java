...
public interface DgExtractRepository extends JpaRepository<DgExtract, Integer> {
	...
	@Query(name = "getstudentlist" ,nativeQuery = true,value =
		...
		+	" cast(s.EXAM_TYPE as char(4)) as exam_type,'' as tot_grade_points,'' as grand_tot_max,'' as grand_tot_mrks, "
		+	" '' as grand_tot_credit_points, cgpa,'' remarks,s.sgpa,'' as abc_account_id,'' as term_type,'' as tot_grade,'' as AADHAAR_NAME,'' as ADMISSION_YEAR "
		...
		+	" sp.current_semester from cms_live.student_program as sp "
